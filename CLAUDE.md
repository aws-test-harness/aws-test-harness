...
- **Show commit message and diff for approval before committing** - Before creating any commit, show the proposed commit message and full diff content. Only after receiving user approval, complete the commit and push in one operation
