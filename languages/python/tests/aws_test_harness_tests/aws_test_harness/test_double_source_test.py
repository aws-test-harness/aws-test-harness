...
@pytest.fixture(scope='function')
def test_double_source(resource_registry, invocation_post_office, invocation_handler_repeating_task_scheduler,
                       boto_session, aws_resource_factory):
    return TestDoubleSource(resource_registry, invocation_post_office, invocation_handler_repeating_task_scheduler,
