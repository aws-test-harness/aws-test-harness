...
from test_doubles_macro_tests.support.step_functions_utils import execute_state_machine
...
def test_generates_cloudformation_resources_that_define_a_state_machine_whose_behaviour_can_be_controlled(
    ...
    assert echoing_function_event['input'] == dict(colour='orange', size='small')
