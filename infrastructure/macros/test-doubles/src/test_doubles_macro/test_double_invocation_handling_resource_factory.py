...
class TestDoubleInvocationHandlingResourceFactory:
    ...
    @staticmethod
    def __generate_function_resource(invocation_handler_function_role_logical_id,
                                     test_double_invocation_queue_logical_id):
        return dict(
...
def handler(event, _):
    sqs_client.send_message(
        ...
        MessageBody=json.dumps(dict(input=event['input'])),
...
'''
    ...
    @classmethod
    def __generate_function_role_resource(cls, test_double_invocation_queue_logical_id):
        return dict(
            Type='AWS::IAM::Role',
            Properties=dict(
    ...
    @classmethod
    def __generate_queue_resource(cls):
